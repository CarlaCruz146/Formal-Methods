...
public class SubjectWithGrade {
    ...
    private Grade grade;
    private SubjectType subejctType;

    public SubjectWithGrade(SubjectForStudyPlanEntity subjectForStudyPlan,
            Grade grade, SubjectType subjectType) {
    ...
    public void setSubjectForStudyPlan(
    ...
    public String toString() {
        return "SubjectWithGrade{" + "subjectForStduyPlan=" +
                subjectForStduyPlan + ", grade=" + grade + ", subejctType=" +
                subejctType + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        if (subjectForStduyPlan != null ?
                !subjectForStduyPlan.equals(that.subjectForStduyPlan) :
                that.subjectForStduyPlan != null) {
            return false;
        }
    ...
    public int hashCode() {
        int result =
                subjectForStduyPlan != null ? subjectForStduyPlan.hashCode() :
                        0;
