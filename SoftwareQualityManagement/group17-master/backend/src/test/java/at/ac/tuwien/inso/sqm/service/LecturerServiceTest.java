...
public class LecturerServiceTest {
    ...
    private final LecturerEntity lecturer =
            new LecturerEntity("l12345", "lecturer", "l12345@uis.at");
    ...
    public void generateQRUrlTest() throws UnsupportedEncodingException {
        ...
        String expectedUrl =
                "https://chart.googleapis" +
                        ".com/chart?chs=200x200&chld=M%%7C0&cht=qr&chl" +
                        "=otpauth%3A%2F%2Ftotp%2FUIS%3Anull%3Fsecret%3D12345" +
                        "%26issuer%3DUIS";
