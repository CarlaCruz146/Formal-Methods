...
public class DataInitializer {
            ...
            new HashMap<String, Subject>() {
                {
                    put("VU Programmkonstruktion",
                            new Subject("VU Programmkonstruktion",
                                    new BigDecimal(8.8)));
                    put("UE Studieneingangsgespräch",
                            new Subject("UE Studieneingangsgespräch",
                                    new BigDecimal(0.2)));
                    put("VU Technische Grundlagen der Informatik", new Subject(
                            "VU Technische Grundlagen der Informatik",
                            new BigDecimal(6.0)));
                    put("VO Algebra und Diskrete Mathematik für Informatik " +
                            "und Wirtschaftsinformatik", new Subject(
                            "VO Algebra und Diskrete Mathematik für " +
                                    "Informatik und Wirtschaftsinformatik",
                            new BigDecimal(4.0)));
                    put("UE Algebra und Diskrete Mathematik für Informatik " +
                            "und Wirtschaftsinformatik", new Subject(
                            "UE Algebra und Diskrete Mathematik für " +
                                    "Informatik und Wirtschaftsinformatik",
                            new BigDecimal(5.0)));
            ...
            new HashMap<String, Subject>() {
                {
                    ...
                    put("VU Algorithmen und Datenstrukturen 2",
                            new Subject("VU Algorithmen und Datenstrukturen 2",
                                    new BigDecimal(3.0)));
                    put("VU Einführung in Visual Computing",
                            new Subject("VU Einführung in Visual Computing",
                                    new BigDecimal(6.0)));
                    ...
                    put("VU Basics of Human Computer Interaction", new Subject(
                            ...
                            new BigDecimal(3.0)));
                    put("VO Analysis für Informatik und Wirtschaftsinformatik",
                            new Subject("VO Analysis für Informatik und " +
                                    "Wirtschaftsinformatik",
                                    new BigDecimal(2.0)));
                    put("UE Analysis für Informatik und Wirtschaftsinformatik",
                            new Subject("UE Analysis für Informatik und " +
                                    "Wirtschaftsinformatik",
                                    new BigDecimal(4.0)));
    ...
    private final Map<String, Subject>
            ...
            new HashMap<String, Subject>() {
                {
                    put("VU Einführung in die Künstliche Intelligenz",
                            new Subject("VU Einführung in die Künstliche " +
            ...
            new HashMap<String, Subject>() {
                {
                    ...
                    put("VU Interface and Interaction Design",
                            new Subject("VU Interface and Interaction Design",
                                    new BigDecimal(3.0)));
                    put("VU Einführung in wissensbasierte Systeme", new Subject(
    ...
    private final Map<String, Subject>
            ...
            new HashMap<String, Subject>() {
                {
                    put("PR Bachelorarbeit für Informatik und " +
                            "Wirtschaftsinformatik", new Subject(
                            "PR Bachelorarbeit für Informatik und " +
                                    "Wirtschaftsinformatik",
                            new BigDecimal(10.0)));
                }
            };
    private final Map<String, Subject>
            ...
            new HashMap<String, Subject>() {
                {
                    put("VU Propädeutikum für Informatik",
                            new Subject("VU Propädeutikum für Informatik",
                                    new BigDecimal(6.0)));
                    put("VO Deklaratives Problemlösen",
                            new Subject("VO Deklaratives Problemlösen",
                                    new BigDecimal(3.0)));
                    put("UE Deklaratives Problemlösen",
                            new Subject("UE Deklaratives Problemlösen",
                                    new BigDecimal(3.0)));
                    ...
                    put("UE Programmierung von Betriebssystemen", new Subject(
                            ...
                            new BigDecimal(3.0)));
                    put("VU Übersetzerbau", new Subject("VU Übersetzerbau",
                            new BigDecimal(6.0)));
                    ...
                    put("VU Statistical Computing",
                            new Subject("VU Statistical Computing",
                                    new BigDecimal(3.0)));
                    put("VO Logik für Wissensrepräsentation",
                            new Subject("VO Logik für Wissensrepräsentation",
                                    new BigDecimal(3.0)));
                    put("UE Logik für Wissensrepräsentation",
                            new Subject("UE Logik für Wissensrepräsentation",
                                    new BigDecimal(3.0)));
                    ...
                    put("VU Software-Qualitätssicherung",
                            new Subject("VU Software-Qualitätssicherung",
                                    new BigDecimal(6.0)));
                    put("VU Usability Engineering",
                            new Subject("VU Usability Engineering",
                                    new BigDecimal(3.0)));
                    put("SE Coaching als Führungsinstrument 2",
                            new Subject("SE Coaching als Führungsinstrument 2",
                                    new BigDecimal(3.0)));
                    ...
                    put("VO EDV-Vertragsrecht",
                            new Subject("VO EDV-Vertragsrecht",
                                    new BigDecimal(1.5)));
                    put("VO Einführung in Technik und Gesellschaft",
                            new Subject(
                                    "VO Einführung in Technik und Gesellschaft",
                                    new BigDecimal(3.0)));
                    put("SE Folgenabschätzung von Informationstechnologien",
                            new Subject("SE Folgenabschätzung von " +
                    ...
                    put("VU Softskills für TechnikerInnen",
                            new Subject("VU Softskills für TechnikerInnen",
                                    new BigDecimal(3.0)));
                    ...
                    put("VU Präsentation und Moderation",
                            new Subject("VU Präsentation und Moderation",
                                    new BigDecimal(3.0)));
    ...
    private final Map<String, Subject> subjectsFreeChoiceInformatics =
            new HashMap<String, Subject>() {{
                ...
                put("VU Robotik für RoboCup",
                        new Subject("VU Robotik für RoboCup",
                                new BigDecimal(6.0)));
                ...
                put("PR Praktikum aus IT-Security",
                        new Subject("PR Praktikum aus IT-Security",
                                new BigDecimal(6.0)));
                put("SE Formale Semantik natürlicher Sprache",
                        new Subject("SE Formale Semantik natürlicher Sprache",
                                new BigDecimal(3.0)));
                put("VO Ausgewählte Kapitel der Technischen Informatik",
                        new Subject("VO Ausgewählte Kapitel der Technischen " +
                                "Informatik", new BigDecimal(3.0)));
                put("SE Seminar für DiplomandInnen",
                        new Subject("SE Seminar für DiplomandInnen",
                                new BigDecimal(2.0)));
                put("SE Computer Vision Seminar für DiplomandInnen",
                        new Subject(
                ...
                put("VU Softwaretechische Konzepte und " +
                                ...
                                " von Objekten " +
                                "und Geräten: RFID, Smartcards, NFC und " +
                                "Mobile Phones",
                        new Subject("VU Softwaretechische Konzepte und " +
                                "Infrastrukturtechnologien zur " +
                                "Identifikation von Objekten und Geräten: " +
                                "RFID, Smartcards, NFC und Mobile Phones",
                                new BigDecimal(3.0)));
                put("VU Advanced Services Engineering",
                        new Subject("VU Advanced Services Engineering",
                                new BigDecimal(3.0)));
                put("SE Forschungsseminar für DiplomandInnen",
                        new Subject("SE Forschungsseminar für DiplomandInnen",
                                new BigDecimal(3.0)));
                put("VO Finanzmärkte, Finanzintermediation und Kapitalanlage",
                        new Subject(
                                "VO Finanzmärkte, Finanzintermediation und " +
                ...
                put("VU Privacy Enhancing Technologies",
                        new Subject("VU Privacy Enhancing Technologies",
                                new BigDecimal(3.0)));
                put("VU Theoretische Informatik und Logik für CI", new Subject(
                ...
                put("SE Theorie und Praxis der Evaluierung von innovativen " +
                        ...
                        new BigDecimal(3.0)));
                put("VU Brückenkurs Programmierung für Studienanfängerinnen",
                        new Subject("VU Brückenkurs Programmierung für " +
                                "Studienanfängerinnen", new BigDecimal(3.0)));
                ...
                put("SE Critical Algorithm Studies",
                        new Subject("SE Critical Algorithm Studies",
                                new BigDecimal(3.0)));
                put("VU Brückenkurs Programmierung für Studienanfänger",
                        new Subject("VU Brückenkurs Programmierung für " +
                                "Studienanfänger", new BigDecimal(3.0)));
            }};
    private final Map<String, Tag> tags = new HashMap<String, Tag>() {{
        ...
        put("Softwarequalitätssicherung",
                new Tag("Softwarequalitätssicherung"));
    ...
    private void registerSubjectsToLecturers() {
        subjectsBachelorSoftwareAndInformationEngineering
                .get("UE Studieneingangsgespräch")
        ...
        s = subjectsBachelorSoftwareAndInformationEngineering
                .get("VO Algebra und Diskrete Mathematik für Informatik und " +
                        "Wirtschaftsinformatik");
        s.addLecturers(lecturers.get(3));
        subjectRepository.save(s);
    }
    ...
    private void addTagsToBachelorSoftwareAndInformationEngineeringCoursesSemester1() {
        ...
        coursesBachelorSoftwareAndInformationEngineering
                .get("UE Algebra und Diskrete Mathematik für Informatik und " +
                        "Wirtschaftsinformatik")
    ...
    private void addTagsToBachelorSoftwareAndInformationEngineeringCoursesSemester2() {
        ...
        coursesBachelorSoftwareAndInformationEngineering
                .get("VU Einführung in Visual Computing")
        ...
        coursesBachelorSoftwareAndInformationEngineering
                .get("VO Analysis für Informatik und Wirtschaftsinformatik")
        ...
        coursesBachelorSoftwareAndInformationEngineering
                .get("UE Analysis für Informatik und Wirtschaftsinformatik")
    ...
    private void addTagsToBachelorSoftwareAndInformationEngineeringCoursesSemester3() {
        coursesBachelorSoftwareAndInformationEngineering
                ...
                .addTags(tags.get("VU"), tags.get("Objektorientiert"),
                        ...
                        tags.get("Generizität"), tags.get("Theorie"),
                        tags.get("Praxis"));
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                .addTags(tags.get("VU"), tags.get("EER"),
                        tags.get("Relationenmodel"), tags.get("Domänenkalkül"),
                        tags.get("Datenbanksprachen"), tags.get("Normalformen"),
                        tags.get("SQL"), tags.get("Datenintegrität"),
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                .addTags(tags.get("VO"), tags.get("Mathe"),
                        ...
                        tags.get("Wahrscheinlichkeitsräume"),
                        tags.get("Stochastik"), tags.get("Grundlagen"),
                        tags.get("Gesetz der großen Zahlen"),
    ...
    private void addTagsToBachelorSoftwareAndInformationEngineeringCoursesSemester4() {
        coursesBachelorSoftwareAndInformationEngineering
                .get("VU Einführung in die Künstliche Intelligenz")
                .addTags(tags.get("VU"), tags.get("Künstliche Intelligenz"),
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                .addTags(tags.get("VU"), tags.get("Automaten"),
                        ...
                        tags.get("formale Grammatiken"),
                        tags.get("Aussagenlogik"), tags.get("Petri-Netze"),
                        tags.get("Prädikatenlogik"), tags.get("Diffizil"),
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                .addTags(tags.get("VO"), tags.get("Theorie"),
                        ...
                        tags.get("Softwarequalitätssicherung"),
                        tags.get("Risikomanagement"),
                        tags.get("Qualitätsmanagement"),
    ...
    private void addTagsToBachelorSoftwareAndInformationEngineeringCoursesSemester5() {
        ...
        coursesBachelorSoftwareAndInformationEngineering
                .get("VU Einführung in wissensbasierte Systeme")
                .addTags(tags.get("VU"), tags.get("Theorie"),
                        ...
                        tags.get("Nichtmonotones Schließen"),
    ...
    private void addTagsToBachelorSoftwareAndInformationEngineeringOptionalCourses() {
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                .addTags(tags.get("VO"), tags.get("Theorie"),
                        ...
                        tags.get("Übersetzer"), tags.get("Interpreter"),
        ...
        coursesBachelorSoftwareAndInformationEngineering.get("VU Übersetzerbau")
                .addTags(tags.get("VU"), tags.get("Theorie"),
                        tags.get("Übersetzer"), tags.get("Bootstrapping"),
                        tags.get("Assembler"), tags.get("Programmieren"),
                        tags.get("Programmiersprachen"),
    ...
    private void addDescriptionToBachelorSoftwareAndInformationEngineeringCoursesSemester1() {
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "Datenstrukturen\n" +
                        "Kennen der häufigsten Fehlerquellen in der " +
                        "Programmierung\n" +
                        ...
                        "(einschließlich Rekursion und Ein- und Ausgabe)\n" +
                        "Fundamentale Entwurfskonzepte, " +
                        "Problemlösungsstrategien, Algorithmen und " +
                        "Datenstrukturen (einschließlich abstrakter " +
                        "Datentypen)\n" +
                        ...
                        "Programmierwerkzeuge (einschließlich geeigneter " +
                        ...
                        "Lehrveranstaltung (abgekürzt PK) abgedeckt. PK " +
                        "bildet die erste Stufe der Programmierausbildung " +
                        "für alle Bachelorstudien der Informatik und " +
                        ...
                        "In ehemaligen Studienplänen waren statt PK die " +
                        ...
                        "alten Studienplans nicht benötigen) können " +
                        "nach wie vor die jeweils andere " +
                        "Lehrveranstaltung besuchen. Studierende, auf" +
                        " die diese Voraussetzungen nicht zutreffen," +
                        " können statt GPK und PP nur mehr PK " +
                        "besuchen.\n" + "\n" + "Ablauf\n" + "\n" +
                        "Die wöchentlich vier Vorlesungseinheiten im Audi.Max" +
                        ...
                        "Studierende nehmen wiederholt an zweistündigen " +
                        "geleiteten Übungen in Gruppen zu ca. 25 Personen " +
                        "teil. Die Anmeldung zu einer dieser Gruppen ist " +
                        "erst nach der Anmeldung zur LV möglich (Die " +
                        "Anmeldefrist für die Gruppenanmeldung wird " +
                        "separat angekündigt). Diese Übungen mit " +
                        "Anwesenheitspflicht bilden einen wesentlichen " +
                        "Bestandteil der Beurteilung. Ausgewählte " +
                        "Teilnehmer(innen) präsentieren ihre Lösungen" +
                        " der Aufgabenblätter und beantworten Fragen" +
                        ". Einen Schwerpunkt bilden " +
                        "Programmieraufgaben, die vor Ort alleine " +
                        "am Computer zu lösen sind. Alle Übungen " +
                        "finden in den Räumen des Informatik " +
                        "Labors (InfLab) zu unterschiedlichen " +
                        "Zeiten statt, abhängig von den " +
                        "Anmeldungen zu Gruppen.\n" + "\n" +
                        "Drei reguläre Tests bilden den Schwerpunkt der " +
                        "Beurteilung. Sie finden am 16. November, 7.Dezember" +
                        " und 25. Jänner in mehreren Labors und zu mehreren" +
                        " Terminen an Computern (mit ähnlicher Software " +
                        "wie bei den Übungen) statt. Der Test im November" +
                        " dauert 45 Minuten, die beiden Tests im " +
                        "Dezember und Jänner je 90 Minuten.\n" + "\n" +
                        ...
                        "absolvieren die geleiteten Übungen in " +
                        "speziellen Übungsgruppen für Fortgeschrittene" +
                        ". Es ist nicht möglich an normalen " +
                        "Übungsgruppen teilzunehmen, wenn beim " +
                        "Einstufungstest mindestens 70% erreicht " +
                        "wurden. Das Ergebnis des Einstufungstests" +
                        " ist für den ersten regulären Test " +
                        ...
                        "regulären Test mitmachen, " +
                        "verfallen die Punkte vom " + "Einstufungstest!\n" +
                        "\n" +
                        "Im Februar findet ein Nachtragstest statt. Die " +
                        "Teilnahme ist nur möglich, wenn genau einer der " +
                        "drei regulären Tests negativ oder gar nicht " +
                        "beurteilt wurde. Die Beurteilung des " +
                        "Nachtragstests ersetzt jene dieses regulären " +
                        "Tests. Inhaltlich deckt der Nachtragstest das " +
                        "gesamte Stoffgebiet ab (das genaue Datum wird " +
                        "rechtzeitig über TUWEL angekündigt).\n" + "\n" +
                        "Eine wesentliche Komponente ist das Üben, also das " +
                        "Lösen von Aufgaben nach eigenem Gutdünken zu " +
                        "Übungszwecken. Zur Unterstützung stehen im InfLab " +
                        ...
                        "Für die Teilnahme an den Komponenten der " +
                        "Lehrveranstaltung gelten folgende " +
                        "Voraussetzungen:\n" + "\n" +
                        "Rechtzeitige Anmeldung im TISS.\n" + "\n" +
                        "Für jede Teilnahme an einem Test ist eine " +
                        "Terminreservierung in TUWEL nötig.\n" +
                        "Für die Teilnahme an den geleiteten Übungen ist eine" +
                        " Anmeldung zu einer Übungsgruppe in TUWEL nötig.\n" +
                        "\n" + "Übungsgruppen\n" + "\n" +
                        "Die Anmeldung zu den Übungsgruppen erfolgt im TUWEL" +
                        ".\n" + "\n" +
                        "Die Übungsgruppen beginnen Mitte Oktober. Normale " +
                        "Übungsgruppen werden von Übungsgruppen für " +
                        "Fortgeschrittene unterschieden. Studierende, die " +
                        "beim Einstufungstest mindestens 70% der Punkte " +
                        "erreicht haben, kommen in eine Gruppe für " +
                        ...
                        "normale Übungsgruppe. Diese beiden Arten von" +
                        " Übungsgruppen unterscheiden sich " +
                        "folgendermaßen voneinander:\n" + "\n" +
                        "Normale Übungsgruppen haben insgesamt 9 " +
                        "Übungstermine und beginnen zu Semesterbeginn.\n" +
                        "\n" +
                        "Übungsgruppen für Fortgeschrittene haben insgesamt 5" +
                        " Übungstermine. Der erste Übungstermin ist erst " +
                        "nach dem ersten regulären Test.\n" + "\n" +
                        "Übungsaufgaben für Fortgeschrittene können sich von " +
                        "denen normaler Übungsgruppen unterscheiden.\n" + "\n" +
                        "Einige der unten genannten Übungstermine werden (je " +
                        "nach Teilnehmerzahl) möglicherweise nicht angeboten" +
                        ".\n" + "\n" + "Übungsumgebung\n" + "\n" +
                        "Zu Beginn der geleiteten Übungen erhalten Teilnehmer" +
                        "(innen) Zugangsdaten zu einem Account auf dem " +
                        "Übungsrechner. Dort ist die zum Lösen der Aufgaben" +
                        " nötige Software installiert. Auch die Betreuer " +
                        "haben Zugang zu den Daten in der Übungsumgebung." +
                        " In der ersten geleiteten Übung erfolgt eine " +
                        "kurze Einweisung in die Verwendung der " +
                        "Übungsumgebung. Während der geleiteten " +
                        "Übungen bleibt man in der Regel stets in " +
                        "diese Übungsumgebung eingeloggt. " +
                        "Aufgabenblätter können ebenfalls in dieser" +
                        " Übungsumgebung gelöst werden.\n" + "\n" +
                        "Kommunikation\n" + "\n" +
                        ...
                        "regelmäßig zu lesen, da manche Mails eine " +
                        "kurzfristige Aktion erfordern.\n" + "\n" +
                        "Durch die erste Anmeldung zu einer Übungsgruppe " +
                        "erhält jede(r) Teilnehmer(in) die Kontaktadresse " +
                        "einer Tutorin oder eines Tutors, der oder die für " +
                        "die persönliche Betreuung zuständig ist. Dies(e) " +
                        "Tutor(in) dient als wichtigste Anlaufstelle bei " +
                        "Problemen und zur Klärung offener Fragen aller " +
                        "Art.\n" + "\n" +
                        "Fragen können auch an die Adresse pk@complang.tuwien" +
                        ".ac.at gerichtet werden.\n" + "\n" +
                        "Vor und nach Vorlesungen und Übungen sowie in Pausen" +
                        " können Teilnehmer(innen) die Lehrenden gerne " +
                        "direkt ansprechen und Fragen stellen. Daneben " +
                        "bietet jeder Lehrende eine wöchentliche " +
                        "Sprechstunde an, zu der Sie auch ohne " +
                        "Voranmeldung kommen können. Für genaue Termine " +
                        "klicken Sie bitte auf den Namen des jeweiligen" +
                        " Vortragenden.\n" + "\n" +
                        "DIE ANMELDUNG ZU DEN ÜBUNGSGRUPPEN ERFOLGT ÜBER " +
                        "TUWEL !\n" + "\n" + " \n" + "ECTS-Breakdown:\n" +
                        "3.0 ECTS (75 Stunden) für Teilnahme an Vorlesungen " +
                        "inklusive Vor- und Nachbereitung und Lösen der " +
                        "dabei gestellten Aufgaben\n" + "\n" +
                        "3.6 ECTS (90 Stunden) für Lösen der Übungsaufgaben " +
                        "und Teilnahme an geleiteten Übungen\n" + "\n" +
                        "2.2 ECTS (55 Stunden) für Testvorbereitung und " +
                        "Testteilnahme\n");
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "Die Lernaktivitäten umfassen Vorlesungseinheiten, " +
                        "Übungen in Kleingruppen (\"Tafelübungen\"), sowie " +
                        "drei schriftliche Tests.\n" + "\n" +
                        "Weitere Informationen\n" +
                        "Vorbesprechung: Di., 4.10.2016, 10:00 Uhr, Hörsaal " +
                        "GM1 (Audi Max)\n" + "\n" +
                        "Die Vorlesungen finden im Hörsaal GM1 (Audi Max) " +
                        "statt; jeweils am Dienstag von 10:00-11:00, am " +
                        "Donnerstag von 10:00-12:00 und am Freitag von " +
                        "10:00-12:00. Erste reguläre Vorlesung am Do., 6" +
                        ".10.2016.\n" + "\n" +
                        "Aufwandsabschätzung (ECTS Breakdown): 150 Stunden = " +
                        "6 ECTS\n" + "\n" +
                        ...
                        "für die Übungsbeispiele finden Sie im TUWEL-Kurs " +
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        "Erwerb grundlegender Kenntnisse und Fähigkeiten aus " +
                        "Mathematik.\n" + "\n" +
                        "Inhalt der Lehrveranstaltung\n" +
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "Inhalt der Lehrveranstaltung\n" +
                        "Übungsaufgaben zum Stoff der gleichnamigen " +
                        "Vorlesung\n" + "\n" + "Weitere Informationen\n" +
                        "Achtung: Aktuelle Beginnzeiten für alle Gruppen und " +
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "vermitteln und sie zu befähigen, mit diesen " +
                        ...
                        " verstehen, sodass sie selbständig ihr Wissen" +
                        " an Hand von Fachliteratur vertiefen können" + ".\n" +
                        "\n" + "Inhalt der Lehrveranstaltung\n" +
                        "Aussagenlogik, endliche Automaten, reguläre " +
                        "Ausdrücke, formale Grammatiken, Petri-Netze, " +
                        "Prädikatenlogik als Spezifikationssprache.\n" + "\n" +
                        "Die Vermittlung dieser Inhalte erfolgt durch einen " +
                        "Vorlesungsteil und durch selbständig zu lösende " +
                        "Übungsaufgaben. Die Beurteilung setzt sich aus der" +
                        " Bewertung dieser Aufgaben, einer schriftlichen " +
                        "Leistungsüberprüfung und zwei Abgabegesprächen " +
                        "zusammen.\n" + "\n" + "Weitere Informationen\n" +
                        "Aufwandsabschätzung\n\n" +
                        ...
                        " 8.0 h Vorbereitung auf 2.Abgabegespräch (1 Tag x " +
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "Emails bitte ausschließlich an dm@dbai.tuwien.ac" +
                        ".at\n" + "\n" + "Achtung:\n" +
                        "Für alle StudienanfängerInnen der Bachelorstudien " +
                        "der Fakultät für Informatik der TU Wien ab dem " +
                        "Sommersemester 2011 gilt: \n" +
                        "Voraussetzung für eine positive Absolvierung dieser " +
                        "LVA ist, dass bis zum Anmeldetermin das " +
                        "Studieneingangsgespräch (STEG) der Fakultät für " +
                        ...
                        "2h Abgabegespräche (bzw. Test) zu den " +
                        "Übungsblättern\n" + "1h SQL Test\n" +
                        "1h Abschlussprüfung\n" +
                        "-----------------------------\n" + "75h (3 ECTS)\n" +
                        "-----------------------------");
    ...
    private void addDescriptionToBachelorSoftwareAndInformationEngineeringCoursesSemester2() {
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                .setDescription("Ziele der Lehrveranstaltung\n" +
                        ...
                        ".\n" + "\n" + "Weitere Informationen\n" +
                        "Erste Übungsstunden: 15.03. (für UE am Dienstag), 16" +
                        ".03. (für UE am Mittwoch), 10.03. (für UE am " +
                        "Donnerstag)\n" + "\n");
    }
    ...
    private void addDescriptionToBachelorSoftwareAndInformationEngineeringCoursesSemester3() {
        coursesBachelorSoftwareAndInformationEngineering
                ...
                .setDescription("Ziele der Lehrveranstaltung\n" +
                        ...
                        "Verständnisses der Wiederverwendung von " +
                        "Programmteilen\n" +
                        "Kognitive und praktische Fertigkeiten\n" +
                        ...
                        "Einsatz bewährter Methoden zur Modellbildung, " +
                        "Lösungsfindung und Evaluation im Bereich der " +
                        "objektorientierten Programmierung\n" +
                        "Umgang mit unspezifizierten und unvollständig " +
                        "spezifizierten Problemsituationen\n" +
                        "Kritische Bewertung und Reflexion von Lösungen\n" +
                        "Soziale Kompetenzen, Innovationskompetenz und " +
                        "Kreativität\n" +
                        "Der Übungsbetrieb fördert die Selbstorganisation und" +
                        " Eigenverantwortlichkeit sowie das Finden kreativer" +
                        " Problemlösungen und eigenständiger " +
                        "Lösungsstrategien.\n" +
                        "Die Arbeit in Gruppen stärkt die Teamfähigkeit.\n" +
                        "Die Vermittlung von Hintergrundwissen fördert die " +
                        "Neugierde an Themen im Bereich der " +
                        "objektorientierten Programmiersprachen und des " +
                        "objektorientierten Paradigmas.\n" +
                        "Inhalt der Lehrveranstaltung\n" +
                        "Überblick über das objektorientierte " +
                        ...
                        "Sprachkonzepte für Generizität, Nebenläufigkeit und " +
                        ...
                        "Genaue Betrachtung der Ersetzbarkeit und anderer für" +
                        ...
                        "Ausgewählte Entwurfsmuster und objektorientierte " +
                        "Programmiertechniken\n" + "Weitere Informationen\n" +
                        "Webseite\n" + "Siehe http://www.complang.tuwien.ac" +
                        ".at/franz/objektorientiert.html für weitere " +
                        "Informationen.\n" + "\n" +
                        "Didaktische Vorgehensweise\n" +
                        "Wöchentliche Vorlesungen vermitteln den eher " +
                        "theoretischen Stoff und geben " +
                        "Hintergrundinformationen. Ebenso beinahe " +
                        "wöchentlich sind Programmieraufgaben, die auf den" +
                        " Vorlesungsstoff Bezug nehmen, in Kleingruppen " +
                        "zu lösen. Zur Erreichung der Ziele wird großer " +
                        "Wert auf das selbständige Finden von " +
                        "Lösungswegen und individuelle Lösungen " +
                        "gelegt; der eigene Weg zur Lösung ist " +
                        "wichtiger als die Lösung selbst.\n" + "\n" +
                        "Aufwand\n" +
                        "Für die Lösung der Programmieraufgaben und das " +
                        "entsprechende Abgabegespräch (Übungsteil) wird eine" +
                        " Aufwand im Umfang von 2 ECTS (50 Stunden) " +
                        "angenommen, für die Teilnahme an Vorlesungen, die" +
                        " Erarbeitung der Vorlesungsinhalte und die " +
                        "Prüfung (Theorieteil) ist ein Aufwand von 1 " +
                        "ECTS (25 Stunden) vorgesehen.\n" + "\n" +
                        "Hinweise zur Anmeldung\n" +
                        "Sie müssen sich sowohl zur Lehrveranstaltung als " +
                        "auch zu einer der zahlreichen Übungsgruppen mit " +
                        ...
                        " hier sichtbaren Gruppen werden erst im Jänner " +
                        "zur Anmeldung zum Abgabegespräch dienen. Die " +
                        "genauen Termine für Abgabegespräche sowie " +
                        "Prüfungen werden sich bis zum Jänner noch " +
                        "ändern, aber ungefähr in den Zeiträumen " +
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "theoretisches und\n" +
                        "praktisches Verständnis der Grundlagen, Prinzipien " +
                        "und Konzepte der\n" +
                        "funktionalen Programmierung und lernen, diese auf " +
                        "ihre Eignung zur\n" +
                        "Lösung programmiertechnischer Aufgaben zu bewerten " +
                        "und zielorientiert\n" +
                        "und angemessen im funktionalen Programmierstil " +
                        "einzusetzen und\n" + "anzuwenden.\n" + "\n" + "\n" +
                        "Inhalt der Lehrveranstaltung\n" +
                        "Die Vorlesung führt in Theorie und Praxis in die " +
                        "Prinzipien und\n" +
                        "Konzepte des funktionalen Programmierstils ein und " +
                        "spannt dabei den\n" +
                        "Bogen von den Grundlagen bis zur Anwendung. In der\n" +
                        "vorlesungsbegleitenden Plenumsübung Haskell Live " +
                        "wird am Beispiel\n" +
                        "konkreter Aufgabenstellungen praktisch vorgeführt " +
                        "und diskutiert, wie\n" +
                        "sich diese zur Lösung einsetzen lassen. Dabei können" +
                        " insbesondere auch\n" +
                        "eigene Lösungsvorschläge vorgestellt und zur " +
                        "Diskussion gestellt\n" +
                        "werden. Im Übungsteil wird der funktionale " +
                        "Programmierstil anhand von\n" +
                        "Beispielen eigenständig angewendet und eingeübt und " +
                        "so ein vertieftes\n" +
                        "theoretisches und praktisches Verständnis für die " +
                        "Konzepte und\n" +
                        "Prinzipien funktionaler Programmierung erarbeitet " +
                        "und erworben. Als\n" +
                        "Demonstrations- und Implementierungssprache wird in " +
                        "Vorlesung und\n" +
                        "Übung die funktionale state-of-the-art " +
                        ...
                        "Std.\n" +
                        "\"Haskell Live\"-Plenumsübungsbesuch und \"Haskell " +
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "und Fertigkeiten:\n" + "\n" +
                        "Kenntnisse über die Rolle und Aufgaben von " +
                        "Betriebssystemen\n" +
                        "Verstehen von Designentscheidungen für das " +
                        "Management von Systemressourcen\n" +
                        "Verständnis der Mechanismen zur Koordination und " +
                        ...
                        "und Hardwareunterstützung, Seitenaustausch, " +
                        ...
                        "in der Vorlesung präsentiert und mit Beispielen " +
                        "illustriert. Ausgewählte Problemstellungen werden " +
                        "in der parallel abgehaltenen Übung in der " +
                        ...
                        " Prüfungsvorbereitung, 2 Std. Prüfung");
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "Didaktisches Vorgehen: Ausgewählte Problemstellungen" +
                        " aus der Betriebssystemprogrammierung werden in der" +
                        " Systemprogrammiersprache C unter UNIX (Linux) " +
                        "programmiert. Einführungswissen zu den " +
                        "Aufgabestellungen und zur Systemprogrammierung " +
                        "wird in begleitenden Vortragsblöcken angeboten" +
                        ".\n" + "\n" + "Weitere Informationen\n" +
                        "ECTS Breakdown: 4 ECTS = 100 Stunden; 12 Std. " +
                        "Einführungsblöcke, 84 Std. Programmierbeispiele, 4 " +
                        "Std. Tests\n" + "\n");
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "Einführung in unterschiedliche Aspekte der " +
                        ...
                        " Wissen, das für alle Studierenden der " +
                        "unterschiedlichen Informatik-Studien relevant" +
                        " ist und für Interessierte die Basis für " +
                        ...
                        "dargestellt. Im Übungsteil, der v.a. " +
                        ...
                        "Einführung in die IT-Sicherheit/ Grundlagen der " +
                        "IT-Sicherheit \n" +
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "zu den für das Internet bzw. die " +
                        "Informationsgesellschaft relevanten rechtlichen " +
                        "Aspekten zu eröffnen und für aktuelle " +
                        ...
                        "Gastvorträge externer Experten geplant. " +
                        "Eine aktive Auseinandersetzung mit den " +
                        "die Vorlesung unterstützenden " +
                        ...
                        "Nachmeldetermine (Hier haben Sie die Möglichkeit, " +
                        ...
                        " Ort: Vorraum zum Informatikhörsaal.\n" +
        ...
        coursesBachelorSoftwareAndInformationEngineering
                ...
                "Ziele der Lehrveranstaltung\n" +
                        ...
                        "Soziale Kompetenzen, Innovationskompetenz und " +
                        "Kreativität:\n" +
                        "Funktionale Denkweise zum Verständnis deklarativer " +
                        "Abfragesprachen\n" +
                        "Logisches Denken um Abläufe in einem DBMS " +
                        "nachzuvollziehen\n" +
                        "Mathematisch fundierte Vorgehensweise zur Analyse " +
                        "von Methoden in DBMS\n" +
                        "Kenntnisse der eigenen Fähigkeiten und Grenzen, " +
                        "Kritikfähigkeit an der eigenen Arbeit\n" +
                        "Selbstorganisation und Eigenverantwortlichkeit zum " +
                        "eigenständigen Lösen von Laboraufgaben\n" +
                        "Inhalt der Lehrveranstaltung\n" + "Schwerpunkte:\n" +
                        ...
                        "Es gibt 2 Übungen die die Konzepte der Vorlesung " +
                        "vertiefen.\n" +
                        "Die Übungsbeispiele werden, bevor sie starten, in " +
                        "der Vorlesung besprochen.\n" +
                        "Zur Betreuung der Übung gibt es Fragestunden bei den" +
                        " Tutorinnen und Tutoren verteilt auf die Zeit vor " +
                        "den Abgabeterminen.\n" +
                        "Die Übung besteht hauptsächlich aus " +
                        "Programmieraufgaben und fließt zu 25% in die " +
                        "Gesamtnote ein.\n" +
                        "Um für alle Studierenden gleiche Voraussetzungen bei" +
                        " der Abgabe zu schaffen gibt es einen einheitlichen" +
                        " Abgabetermin für alle Studenten gefolgt von den " +
                        "Abgabegesprächen.\n" +
                        "Bei den Abgabegesprächen werden die Beispiele auf " +
                        "Korrektheit, aber besonders auf das Verständnis " +
                        "geprüft, und entsprechend Feedback gegeben.\n" +
                        "Die Prüfung besteht aus einem Theorieteil und " +
                        "praktischen Beispielen.\n" +
                        "Es gibt vier Prüfungstermine (einen am Semesterende," +
                        " drei weitere im Folgesemester) die zu 75% in die " +
                        "Note einfließen.\n" +
                        "Bitte beachten Sie für diese LVA unbedingt auch die " +
                        "lokale Homepage der Lehrveranstaltung.\n" + "\n");

        coursesBachelorSoftwareAndInformationEngineering
                .get("VO Statistik und Wahrscheinlichkeitstheorie")
                .setDescription("Ziele der Lehrveranstaltung\n" +
                        "Verständnis von Wahrscheinlichkeiten zur " +
                        "Beschreibung realer Phänomene sowie Fähigkeit zur " +
                        ...
                        "Wahrscheinlichkeitsräume und stochastische " +
                        "Größen, stochastische Unabhängigkeit, Gesetz " +
                        "der großen Zahlen und zentraler " +
                        "Grenzverteilungssatz, Fundamentalsatz der " +
                        "Statistik, klassische schließende " +
    ...
    private void registerCoursesToStudents() {
        ...
        register(studentMap.get("Joan Watson"),
                coursesBachelorSoftwareAndInformationEngineering
                        .get("VO Algebra und Diskrete Mathematik für " +
                                "Informatik und Wirtschaftsinformatik"));
        ...
        register(similarToMathematician,
                coursesBachelorSoftwareAndInformationEngineering
                        .get("UE Algebra und Diskrete Mathematik für " +
                                "Informatik und Wirtschaftsinformatik"));
        register(similarToMathematician,
                coursesBachelorSoftwareAndInformationEngineering
                        .get("VO Statistik und Wahrscheinlichkeitstheorie"));
