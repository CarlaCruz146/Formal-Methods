...
public class CreateUserForm {
    ...
    @Pattern(
            regexp = "(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\" +
                    ...
                    "-9]:(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21-\\x5a\\x53" +
    ...
    public CreateUserForm(String type, String identificationNumber, String name,
            String email) {
        this.type = type;
    ...
    public boolean equals(Object o) {
        ...
        if (getIdentificationNumber() != null ? !getIdentificationNumber()
                .equals(that.getIdentificationNumber()) :
                that.getIdentificationNumber() != null) {
            return false;
        }
        ...
        return getEmail() != null ? getEmail().equals(that.getEmail()) :
                that.getEmail() == null;
    ...
    public String toString() {
        return "CreateUserForm{" + "type='" + type + '\'' +
