package at.ac.tuwien.inso.sqm.controller.student.forms;
...
public class FeedbackForm {
    ...
    public boolean equals(Object o) {
        ...
        if (course != null ? !course.equals(that.course) :
                that.course != null) {
            return false;
        }
        return suggestions != null ? suggestions.equals(that.suggestions) :
    ...
    public int hashCode() {
        ...
        result = 31 * result +
                (suggestions != null ? suggestions.hashCode() : 0);
        return result;
    }

    public String toString() {
        return "FeedbackForm{" + "course=" + course + ", like=" + like +
