...
public class LecturerRepositoryTest {
    ...
    public void findLecturerByAccountIdSuccessTest() {
        ...
        UserAccountEntity account =
                new UserAccountEntity("lecturer", "pass", Role.LECTURER);
        LecturerEntity expectedLecturer = uisUserRepository
                .save(new LecturerEntity("l0100011", "Una Walker",
                        "una.walker@uis.at", account));
        Long accountId = account.getId();

        // assert the create lecturer matches with the one found
        LecturerEntity actualLecturer =
                lecturerRepository.findLecturerByAccountId(accountId);
