...
public class PublicGradeTest {
    ...
    public void setUp() {
        ...
        Semester semester = new Semester(2017, SemesterTypeEnum.SummerSemester);
        ...
        LecturerEntity lecturer =
                new LecturerEntity("123", "TestLecturer", "test@lecturer.com");
        lecturerRepository.save(lecturer);

        StudentEntity student =
                new StudentEntity("456", "TestStudent", "test@student.com");
        stduentRepository.save(student);

        grade = gradeRepository.save(new Grade(course, lecturer, student,
    ...
    public void generateGradePDFTest() throws Exception {
        ...
        mockMvc.perform(
                get("/public/grade?identifier=" + grade.getUrlIdentifier())
                        .with(anonymous()).accept(MediaType.APPLICATION_PDF))
