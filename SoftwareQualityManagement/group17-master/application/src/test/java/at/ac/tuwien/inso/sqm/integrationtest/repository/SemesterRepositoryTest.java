...
public class SemesterRepositoryTest {
    ...
    public void findAllSinceWithCurrentSemester() throws Exception {
        assertThat(semesterRepository.findAllSince(semesters.get(1)),
                equalTo(singletonList(semesters.get(1))));
    }

    @Test
    public void findAllSinceWithPastSemester() throws Exception {
        assertThat(semesterRepository.findAllSince(semesters.get(0)),
                equalTo(asList(semesters.get(1), semesters.get(0))));
    }
}
