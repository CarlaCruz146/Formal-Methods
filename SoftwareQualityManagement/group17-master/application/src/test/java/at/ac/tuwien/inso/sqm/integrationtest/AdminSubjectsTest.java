...
public class AdminSubjectsTest extends AbstractSubjectsTest {
    ...
    public void adminShouldBeAbleToDeleteSubjects() throws Exception {
        ...
        // then the admin should see them all in the first page
        mockMvc.perform(post("/admin/subjects/remove/" + cal.getId())
    ...
    @Test
    public void adminSubjectShouldNotBeRemovedIfItContainsCourses()
            throws Exception {
        ...
        Course calculusWS2016 =
                courseRepository.save(calculusWS2016o);
    ...
    public void adminShouldSeeSubjectDetails() throws Exception {
        ...
        mockMvc.perform(get("/admin/subjects/" + id1)
                .with(user("admin").roles("ADMIN")))
                .andExpect(model().attribute("subject", calculus))
                .andExpect(model().attribute("lecturers", asList()));

        //admin should see subject sepm with lecturer1
        mockMvc.perform(get("/admin/subjects/" + id2)
                .with(user("admin").roles("ADMIN")))
                .andExpect(model().attribute("subject", sepm))
                .andExpect(model().attribute("lecturers", asList(lecturer1)));

        //admin should see subject ase with lecturer1 and lecturer2
        mockMvc.perform(get("/admin/subjects/" + id3)
                .with(user("admin").roles("ADMIN")))
                .andExpect(model().attribute("subject", ase)).andExpect(
    ...
    public void adminCreateSubjectTest() throws Exception {
        ...
        mockMvc.perform(post("/admin/subjects/create")
                ...
                .param("name", name).param("ects", ects.toString())
                .with(csrf()));

        Subject subject =
                subjectRepository.findByNameContainingIgnoreCase(name).get(0);
    ...
    public void adminListSubjectsForPageSearchNullAndPageNumberOneTest()
        ...
        mockMvc.perform(get("/admin/subjects/page/1")
                .with(user("admin").roles(Role.ADMIN.name()))
    ...
    public void adminListSubjectsForPageSearchEmptyTest() throws Exception {
        ...
        mockMvc.perform(get("/admin/subjects/page/1")
                ...
                .andExpect(redirectedUrl("/admin/subjects/page/1"));
    ...
    public void adminListSubjectsForPagePageNumberOneTest() throws Exception {
        ...
        mockMvc.perform(get("/admin/subjects/page/1")
                ...
                .with(csrf()))
                .andExpect(redirectedUrl("/admin/subjects?search=something"));
