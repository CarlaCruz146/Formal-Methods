...
public class UisUserRepositoryTest {
    ...
    private final Map<String, UisUserEntity> uisUsers =
            new HashMap<String, UisUserEntity>() {
                {
                    put("lecturer1", new LecturerEntity("l12345", "lecturer1",
                            "l12345@uis.at"));
                    put("lecturer2", new LecturerEntity("l54321", "lecturer2",
                            "l54321@uis.at"));
                    put("student", new StudentEntity("s12345", "student",
                            "s12345@uis.at"));
                }
            };
    @Autowired
    ...
    public void testFindAllMatchingSomeExistingUsersUsingIdentificationNumber() {
        Page<UisUserEntity> foundUsers =
                uisUserRepository.findAllMatching("12345", null);
    ...
    public void testFindAllMatchingSomeExistingUsersUsingNameIgnoreCase() {
        Page<UisUserEntity> foundUsers =
                uisUserRepository.findAllMatching("lecTURer", null);
        assertTrue(foundUsers.getContent().contains(uisUsers.get("lecturer1")));
    ...
    public void testFindAllMatchingSomeExistingUsersUsingEmail() {
        Page<UisUserEntity> foundUsers =
                uisUserRepository.findAllMatching("s12345@uis.at", null);
        assertTrue(foundUsers.getContent().contains(uisUsers.get("student")));
    }

    @Test
    public void testFindAllMatchingNoContent() {
        Page<UisUserEntity> foundUsers = uisUserRepository
                .findAllMatching("some_non_existing_content", null);
    ...
    public void testExistsForExistingIdentificationNumber() throws Exception {
        ...
        assertTrue(uisUserRepository.existsByIdentificationNumber(
                lecturer1.getIdentificationNumber()));
    }

    @Test
    public void testExistsForNonExistingIdentificationNumber()
            throws Exception {
        assertFalse(uisUserRepository
                .existsByIdentificationNumber("some_non_existing_id"));
    }
}
