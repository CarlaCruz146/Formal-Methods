...
public class SemesterProgress {
    ...
    private final SemesterDto semester;

    private final List<CuorseRegistration> cuorseRegistrations;

    public SemesterProgress(SemesterDto semester,
            List<CuorseRegistration> cuorseRegistrations) {
    ...
    public boolean equals(Object o) {
        ...
        return getCuorseRegistrations() != null ?
                getCuorseRegistrations().equals(that.getCuorseRegistrations()) :
                that.getCuorseRegistrations() == null;

    }

    public int hashCode() {
        int result = getSemester() != null ? getSemester().hashCode() : 0;
        result = 31 * result + (getCuorseRegistrations() != null ?
                getCuorseRegistrations().hashCode() : 0);
        return result;
    }

    public String toString() {
        return "SemesterProgress{" + "semester=" + semester +
